...
# Load YOLO model
try:
    model = YOLO('D:\learning\project\Object_detection_using yolo\license-plate-detection\license_plate_detector.pt')  # Replace with the path to your trained YOLO model
